...
from alfe.parser.ex_setup_commands import ExSetupCmd1
from alfe.parser.ex_get_markets import GetMarkets
from alfe.parser.ex_get_instrument_count import GetInstrumentCount
from alfe.parser.ex_get_instrument_quote import GetInstrumentQuote
from alfe.parser.ex_get_minute_time_data import GetMinuteTimeData
from alfe.parser.ex_get_history_minute_time_data import GetHistoryMinuteTimeData
from alfe.parser.ex_get_transaction_data import GetTransactionData
from alfe.parser.ex_get_history_transaction_data import GetHistoryTransactionData
from alfe.parser.ex_get_instrument_bars import GetInstrumentBars
from alfe.parser.ex_get_instrument_info import GetInstrumentInfo
from alfe.parser.ex_get_history_instrument_bars_range import GetHistoryInstrumentBarsRange
from alfe.parser.ex_get_instrument_quote_list import GetInstrumentQuoteList
...
class AlfeExHq_API(BaseSocketClient):
...
if __name__ == '__main__':
    ...
    with api.connect('121.14.110.210', 7727):
        # log.info("Get market codes")
        # pprint.pprint(api.to_df(api.get_markets()))
        # log.info("Query instrument count in market")
        # pprint.pprint(api.get_instrument_count())
        # log.info("Query five-level quotes")
        ...
        # log.info("Query K-lines")
        #pprint.pprint(api.to_df(api.get_instrument_bars(ALFEParams.KLINE_TYPE_DAILY, 8, "10000843")))
        #pprint.pprint(api.to_df(api.get_instrument_bars(ALFEParams.KLINE_TYPE_DAILY, 31, "00700")))
        # log.info("Query code list")
