...
class AlfeExHqDailyBarReader(BaseReader):
...
if __name__ == '__main__':
    alfe_reader = AlfeExHqDailyBarReader()
    try:
        print(alfe_reader.get_df("/Users/rainx/tmp/vipdoc/ds/29#A1801.day"))
        #print(alfe_reader.get_df("/Volumes/share/transfer/76#AG200.day"))
