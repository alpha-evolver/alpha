...
class AlfeDailyBarReader(BaseReader):
...
if __name__ == '__main__':
    alfe_reader = AlfeDailyBarReader('/Users/rainx/tmp/vipdoc/')
    try:
        #for row in alfe_reader.parse_data_by_file('/Volumes/more/data/vipdoc/sh/lday/sh600000.day'):
        #    print(row)
        for row in alfe_reader.get_kline_by_code('000001', 'sz'):
            print(row)
        print(alfe_reader.get_df('000001', 'sz'))
    except AlfeFileNotFoundException as e:
        pass
