...
if __name__ == "__main__":
    import os
    #api = AlfeTradeApi(endpoint="http://10.11.5.215:10092/api", enc_key=b"4f1cf3fec4c84c84", enc_iv=b"0c78abc083b011e7")
    api = AlfeTradeApi(endpoint="http://10.11.5.215:10092/api")
    print("---Ping---")
    result = api.ping()
    print(result)
