...
if __name__ == '__main__':
    ...
    with api.connect('61.152.107.141', 7727):
        print(api.to_df(api.get_instrument_bars(ALFEParams.KLINE_TYPE_EXHQ_1MIN, 74, 'BABA')).tail())
        print(api.to_df(api.get_instrument_bars(ALFEParams.KLINE_TYPE_DAILY, 31, '00001')).tail())
