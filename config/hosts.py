# coding=utf-8
# 服务器连通性测试日期: 2026-03-16
# 测试结果: 10/25 可用

# 优先使用可用服务器 (已验证)
hq_hosts = [
    # ===== 可用服务器 (优先级高) =====
    ("杭州电信主站J1(可用)", "60.191.117.167", 7709),
    ("杭州电信主站J2(可用)", "115.238.56.198", 7709),
    ("杭州电信主站J3(可用)", "218.75.126.9", 7709),
    ("杭州电信主站J4(可用)", "115.238.90.165", 7709),
    ("上证云成都电信一(可用)", "218.6.170.47", 7709),
    ("上证云北京联通一(可用)", "123.125.108.14", 7709),
    ("上海电信主站Z1(可用)", "180.153.18.170", 7709),
    ("杭州联通主站J2(可用)", "60.12.136.250", 7709),
    ...
    # ===== 不可用服务器 (待确认) =====
    ("长城国瑞电信1", "218.85.139.19", 7709),  # 2026-03-16 FAIL
    ("长城国瑞电信2", "218.85.139.20", 7709),  # 2026-03-16 FAIL
    ("长城国瑞网通", "58.23.131.163", 7709),    # 2026-03-16 FAIL
    ("上海电信主站Z2", "180.153.18.171", 7709), # 2026-03-16 FAIL
    ("北京联通主站Z1", "202.108.253.130", 7709), # 2026-03-16 FAIL
    ("北京联通主站Z2", "202.108.253.131", 7709), # 2026-03-16 FAIL
    ("杭州联通主站J1", "124.160.88.183", 7709),  # 2026-03-16 FAIL
    ("杭州华数主站J1", "218.108.98.244", 7709),   # 2026-03-16 FAIL
    ("杭州华数主站J2", "218.108.47.69", 7709),    # 2026-03-16 FAIL
    ("义乌移动主站J1", "223.94.89.115", 7709),    # 2026-03-16 FAIL
    ("青岛联通主站W1", "218.57.11.101", 7709),     # 2026-03-16 FAIL
    ("青岛电信主站W1", "58.58.33.123", 7709),      # 2026-03-16 FAIL
    ("深圳电信主站Z1", "14.17.75.71", 7709),       # 2026-03-16 FAIL
    ("云行情上海电信Z1", "114.80.63.12", 7709),    # 2026-03-16 FAIL
    ("云行情上海电信Z2", "114.80.63.35", 7709),    # 2026-03-16 FAIL
